...
class CipherlibBenchmark extends AsyncBenchmark {
  ...
  Future<dynamic> run() async {
    final cbc = Twofish.noPadding(key).cbc(iv);
...
class PointyCastleBenchmark extends AsyncBenchmark {
  ...
  Future<dynamic> run() async {
    ...
    // encrypt
    final encrypter = CBCBlockCipher(TwofishEngine())..init(true, params);
    ...
    // decrypt
    final decrypter = CBCBlockCipher(TwofishEngine())..init(false, params);
