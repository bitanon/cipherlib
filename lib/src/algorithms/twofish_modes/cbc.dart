...
/// Provides encryption for Twofish cipher in CBC mode.
class TwofishInCBCModeEncrypt extends StreamCipher with SaltedCipher {
  @override
  String get name => "Twofish#encrypt/CBC/${padding.name}";
...
/// Provides decryption for Twofish cipher in CBC mode.
class TwofishInCBCModeDecrypt extends StreamCipher with SaltedCipher {
  @override
  String get name => "Twofish#decrypt/CBC/${padding.name}";
...
/// Provides encryption and decryption for Twofish cipher in CBC mode.
class TwofishInCBCMode extends StreamCipherPair with SaltedCipher {
  @override
  String get name => "Twofish/CBC/${padding.name}";

  @override
  final TwofishInCBCModeEncrypt encryptor;

  @override
  final TwofishInCBCModeDecrypt decryptor;

  const TwofishInCBCMode._({
  ...
  /// Creates Twofish cipher in CBC mode.
  ///
  /// Parameters:
  ...
  factory TwofishInCBCMode(
    ...
    return TwofishInCBCMode._(
      encryptor: TwofishInCBCModeEncrypt(key8, iv8, padding),
      decryptor: TwofishInCBCModeDecrypt(key8, iv8, padding),
    );
  }
