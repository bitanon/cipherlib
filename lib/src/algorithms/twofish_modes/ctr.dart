...
/// Provides Twofish cipher in CTR mode.
class TwofishInCTRModeCipher extends StreamCipher with SaltedCipher {
  @override
  String get name => "Twofish#cipher/CTR/${Padding.none.name}";
  ...
  static void _encryptBlock(
    ...
    block32[0] = TwofishCore.$swap32(counter32[0]);
    block32[1] = TwofishCore.$swap32(counter32[1]);
    block32[2] = TwofishCore.$swap32(counter32[2]);
    block32[3] = TwofishCore.$swap32(counter32[3]);
    TwofishCore.$encrypt(block32, key32);
  }
...
/// Provides encryption and decryption for Twofish cipher in CTR mode.
class TwofishInCTRMode extends StreamCipherPair with SaltedCipher {
  @override
  String get name => "Twofish/CTR/${Padding.none.name}";

  @override
  final TwofishInCTRModeCipher encryptor;

  @override
  final TwofishInCTRModeCipher decryptor;

  const TwofishInCTRMode._({
  ...
  /// Creates Twofish cipher in CTR mode.
  ///
  /// Parameters:
  ...
  factory TwofishInCTRMode(
    ...
    var cipher = TwofishInCTRModeCipher(key8, iv8, counterBits);
    return TwofishInCTRMode._(
      encryptor: cipher,
      decryptor: cipher,
    );
  }
  ...
  factory TwofishInCTRMode.iv(
    ...
    return TwofishInCTRMode(key, iv, 64);
  }
}
