...
extension XChaCha20ExtentionForPoly1305 on XChaCha20 {
  ...
  @pragma('vm:prefer-inline')
  @pragma('dart2js:tryInline')
  XChaCha20Poly1305 poly1305() => XChaCha20Poly1305._(this, Poly1305($otk()));
}

/// Encrypts or Decrypts the [message] using XChaCha20 cipher and generates an
...
AEADResultWithIV xchacha20poly1305(
  ...
  final algo = XChaCha20(key, nonce, counter).poly1305();
