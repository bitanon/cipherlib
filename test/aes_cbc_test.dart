...
void main() {
  ...
  group('stream encryptor', () {
    test('bind matches convert with chunked input', () async {
      ...
      final aes = AES.pkcs7(key).cbc(iv);
    ...
    test('bind throws on incomplete final block with no padding', () async {
  ...
  group('stream decryptor', () {
    ...
    test('bind throws on incomplete final ciphertext block', () async {
