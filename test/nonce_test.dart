  ...
  group('correctness', () {
    ...
    group('Nonce64 tests', () {
      ...
      test('Nonce64.bytes should handle different byte lengths', () {
        ...
        expect(
            nonce.bytes, equals(Uint8List.fromList([1, 2, 3, 4, 5, 6, 7, 8])));
      });
      ...
      test('Nonce64.bytes should fill remaining bytes with zeros', () {
        ...
        var nonce = Nonce64.bytes(data);
        expect(
            nonce.bytes, equals(Uint8List.fromList([1, 2, 3, 4, 5, 0, 0, 0])));
      });
